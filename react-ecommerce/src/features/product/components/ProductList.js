                    ...
                    <div className="mt-6 grid grid-cols-1 gap-x-6 gap-y-10 sm:grid-cols-2 lg:grid-cols-3 xl:gap-x-8">
                      {products.map((product) => (
                        <Link to="/product-detail">
                          <div
                            key={product.id}
                            className="group relative border-2 border-gray-200 p-2"
                          >
                ...
                >
                  ...
                  {Array.from({
                    ...
                    return (
                      <div
                        aria-current="page"
                        className={`relative z-10 inline-flex items-center cursor-pointer px-4 py-2 text-sm font-semibold focus:z-20 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 ${
                          index + 1 === page
                            ? "bg-indigo-600 text-white focus-visible:outline-indigo-600"
                            : "text-gray-900 ring-gray-300 ring-1 ring-inset "
                        }`}
